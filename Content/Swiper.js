...
{
 "use strict";
 var Global,Samples,HelloWorld,WebSharper,Obj,UI,Var$1,Operators,View,Doc,Var,EventTarget,Node,JavaScript,JS,HtmlModule,attr,ConcreteVar,Snap,Pervasives,Client,Templates,WindowOrWorkerGlobalScope,Array,AttrProxy,Abbrev,Fresh,Unchecked,Docs,Collections,Dictionary,Arrays,List,T,Object,DomUtility,Attrs,DocElemNode,CharacterData,SC$1,HashSet,Seq,Enumerator,Elt,T$1,SC$2,Attrs$1,Dyn,DictionaryUtil,Prepare,Slice,KeyCollection,An,Settings,Mailbox,SC$3,Updates,Queue,Strings,Docs$1,RunState,NodeSet,Anims,SC$4,SC$5,SC$6,Concurrency,AppendList,HashSetUtil,Easing,AsyncBody,SC$7,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 ...
 {
  var currentSlideIndex,swiper,r,answerButtons,x,a;
  currentSlideIndex=Var$1.Create$1(0);
  swiper=new Global.Swiper(".swiper-container",(r={},r.onSlideChangeStart=function(swiper$1)
  {
   return Var$1.Set(currentSlideIndex,swiper$1.activeIndex);
  },r));
  answerButtons=Doc.Concat([Doc.TextNode("Pick an answer: "),Doc.Button("A",[],Global.ignore),Doc.Button("B",[],Global.ignore),Doc.Button("C",[],function()
  {
   swiper.unlockSwipeToNext();
   swiper.slideNext();
   swiper.appendSlide(Doc.Element("div",[AttrProxy.Create("class","swiper-slide")],[Doc.TextNode("You have finished the tutorial!")]).elt);
  })]);
  x=Doc.EmbedView(View.Map(function($1)
  {
   return $1===8?(swiper.lockSwipeToNext(),answerButtons):Doc.get_Empty();
  },currentSlideIndex.get_View()));
